...
// while(a < b){ // условие нечетные числа из заданного промежутка
//     if(a % 2 == 0){ //  условие ?????
//         console.log(a); // "a" будет выводиться при каждом повторении цикла
//     }
//     ++a // действие увелечение на один раз 
// }
...
if(a == 0 & 2){
    ...
    alert('прибавьте к ней 15')
} else{
    alert('поделите ее на 10')
}
